...
def plot_results(models,
    ...
    filename1 = "./k-means/data/vae_mean_all"
    # display a 2D plot of the digit classes in the latent space
    z_mean = encoder.predict(x_test, batch_size=batch_size)
    
    with open('./k-means/data/csv_out3.csv', 'w', newline='') as f:
        writer = csv.writer(f)
    ...
    filename2 = "./k-means/data/digits_over_latent_all"
...
vae.save_weights("./k-means/data/vae_mnist_weightsL2_20.h5")
encoder.save_weights("./k-means/data/encoder_mnist_weightsL2_20.h5")
decoder.save_weights("./k-means/data/decoder_mnist_weightsL2_20.h5")
...
for i in range(n):
    ...
    ax.get_xaxis().set_visible(False)
    ax.get_yaxis().set_visible(False)
plt.savefig("./k-means/data/autodetect_all.jpg")
plt.pause(1)
plt.close()
